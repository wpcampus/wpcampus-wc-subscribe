# WPCampus Web Components: Subscribe

The subscribe web component used by the WPCampus organization.

## Install

`npm i @wpcampus/wpcampus-wc-subscribe`

## Usage

Place the element in your HTML markup: `<wpcampus-subscribe></wpcampus-subscribe>`
...
`yarn add /Users/{absolute path to folder}/wpcampus-wc-subscribe --check-files`
